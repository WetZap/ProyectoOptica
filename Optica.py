...
def pedir_datosLINEAL():
    ...
    try:
        ...
        return pedir_datosLINEAL()
    if float (entrada[0])== 0:
        print("El progrma no permite incidencia normal. Por favor, ingrese un valor válido.")
        return pedir_datosLINEAL()
